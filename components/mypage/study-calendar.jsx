    ...
    <div className="w-full">
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex gap-1">
          <Button
            variant="ghost"
            size="icon"
            className="hover:text-[#6DB1B2] rounded-full w-8 h-8"
          >
          ...
          {days.map((day) => {
            ...
            return (
              ...
              >
                <span
                  className={`text-sm ${
                    isStudied ? "text-[#6DB1B2] font-medium" : "text-gray-600"
                  }`}
                >
                  {day}
                </span>
                {isStudied && (
                  <Heart className="w-5 h-5 absolute bottom-1 right-1 fill-[#6DB1B2] text-[#6DB1B2]" />
                )}
              </div>
            );
          })}
      ...
      <div className="mt-6 flex justify-between items-center">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm font-medium text-[#6DB1B2]">
